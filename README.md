...
```scala
libraryDependencies += "com.github.scalaprops" %% "scalaprops-scalazlaws" % "0.3.3" % "test"
```

or you can use [sbt plugin](https://github.com/scalaprops/sbt-scalaprops)

- [API Documentation](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/scalaprops/scalaprops-all_2.11/0.3.3/scalaprops-all_2.11-0.3.3-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/scalaprops/scalaprops-all_2.11/0.3.3/scalaprops-all_2.11-0.3.3-sxr.jar/!/index.html)
...
libraryDependencies += "com.github.scalaprops" %% "scalaprops" % "0.3.4-SNAPSHOT" % "test"
```

```scala
libraryDependencies += "com.github.scalaprops" %% "scalaprops-scalazlaws" % "0.3.4-SNAPSHOT" % "test"
```


- [API Documentation](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/scalaprops/scalaprops-all_2.11/0.3.4-SNAPSHOT/scalaprops-all_2.11-0.3.4-SNAPSHOT-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/scalaprops/scalaprops-all_2.11/0.3.4-SNAPSHOT/scalaprops-all_2.11-0.3.4-SNAPSHOT-sxr.jar/!/index.html)
