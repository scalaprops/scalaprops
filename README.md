...
```scala
libraryDependencies += "com.github.scalaprops" %% "scalaprops-scalaz" % "0.6.2" % "test"
```

</details>


- [API Documentation](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/scalaprops/scalaprops-all_2.12/0.6.2/scalaprops-all_2.12-0.6.2-javadoc.jar/!/scalaprops/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/scalaprops/scalaprops-all_2.12/0.6.2/scalaprops-all_2.12-0.6.2-sxr.jar/!/index.html)
