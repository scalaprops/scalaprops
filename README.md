...
libraryDependencies += "com.github.xuwei-k" %% "scalaprops" % "0.1.4-SNAPSHOT" % "test"
```

```scala
libraryDependencies += "com.github.xuwei-k" %% "scalaprops-scalazlaws" % "0.1.4-SNAPSHOT" % "test"
```


- [API Documentation](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/scalaprops-all_2.11/0.1.4-SNAPSHOT/scalaprops-all_2.11-0.1.4-SNAPSHOT-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/xuwei-k/scalaprops-all_2.11/0.1.4-SNAPSHOT/scalaprops-all_2.11-0.1.4-SNAPSHOT-sxr.jar/!/index.html)
