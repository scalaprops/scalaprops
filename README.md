...
libraryDependencies += "com.github.scalaprops" %% "scalaprops" % "0.1.7" % "test"
```

```scala
libraryDependencies += "com.github.scalaprops" %% "scalaprops-scalazlaws" % "0.1.7" % "test"
```

- [API Documentation](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/scalaprops/scalaprops-all_2.11/0.1.7/scalaprops-all_2.11-0.1.7-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/scalaprops/scalaprops-all_2.11/0.1.7/scalaprops-all_2.11-0.1.7-sxr.jar/!/index.html)
...
libraryDependencies += "com.github.scalaprops" %% "scalaprops" % "0.1.8-SNAPSHOT" % "test"
```

```scala
libraryDependencies += "com.github.scalaprops" %% "scalaprops-scalazlaws" % "0.1.8-SNAPSHOT" % "test"
```


- [API Documentation](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/scalaprops/scalaprops-all_2.11/0.1.8-SNAPSHOT/scalaprops-all_2.11-0.1.8-SNAPSHOT-javadoc.jar/!/index.html)
- [sxr](https://oss.sonatype.org/service/local/repositories/snapshots/archive/com/github/scalaprops/scalaprops-all_2.11/0.1.8-SNAPSHOT/scalaprops-all_2.11-0.1.8-SNAPSHOT-sxr.jar/!/index.html)
