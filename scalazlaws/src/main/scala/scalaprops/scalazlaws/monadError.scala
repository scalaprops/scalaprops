...
object monadError {
  ...
  def raisedErrorsHandled[F[_], E, A](implicit me: MonadError[F, E], eq: Equal[F[A]], ae: Gen[E], afea: Gen[E => F[A]]) =
  ...
  def all[F[_], E: Gen](implicit A1: MonadError[F, E], A2: Gen[F[Int]], A3: Gen[F[Int => Int]], A4: Equal[F[Int]], A5: Gen[E => F[Int]]) =
