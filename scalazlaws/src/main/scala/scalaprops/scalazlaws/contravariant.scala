...
object contravariant {
  ...
  def composite[F[_], X, Y, Z](implicit F: Contravariant[F], af: Gen[F[Z]], axy: Gen[(X => Y)],
                               ayz: Gen[(Y => Z)], ef: Equal[F[X]]) =
    forAll(F.contravariantLaw.composite[Z, Y, X] _)

  def laws[F[_]](implicit F: Contravariant[F], af: Gen[F[Int]], axy: Gen[(Int => Int)],
                 ef: Equal[F[Int]]) =
  ...
  def all[F[_]](implicit F: Contravariant[F], af: Gen[F[Int]], axy: Gen[(Int => Int)],
                ef: Equal[F[Int]]) =
