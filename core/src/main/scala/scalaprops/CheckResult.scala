...
object CheckResult {
  ...
  final case class Falsified(override val succeeded: Int, override val discarded: Int, args: List[Arg], override val seed: Seed) extends CheckResult
  ...
  final case class PropException(override val succeeded: Int, override val discarded: Int, args: List[Arg], exception: Throwable, override val seed: Seed) extends CheckResult
